  ...
  return (
    <section className="bg-primary text-primary-foreground">
      <div className="mx-auto max-w-3xl px-5 py-14 text-center md:py-20">
        ...
        <p className="mt-3 text-base text-primary-foreground/80">{LANDING.finalCta.subtitle}</p>
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          {LANDING.hero.doors.map((door) => (
            <a
              ...
              className="inline-flex items-center justify-center rounded-md bg-background px-5 py-3 text-sm font-semibold text-primary transition-opacity hover:opacity-90"
            >
              {door.title}
            </a>
          ))}
