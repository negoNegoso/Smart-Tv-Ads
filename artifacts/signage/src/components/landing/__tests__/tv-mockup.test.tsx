...
const PIECES = [
  { imageUrl: '/api/storage/objects/h1.jpg', caption: 'Pão quente', orientation: 'landscape' },
  { imageUrl: '/api/storage/objects/h2.jpg', caption: 'Farmácia 24h', orientation: 'landscape' },
  { imageUrl: '/api/storage/objects/v1.jpg', caption: 'Açaí', orientation: 'portrait' },
];
